...
<div class="flex min-h-[calc(100vh-140px)] items-center justify-center px-4 py-8">
    <div class="w-full max-w-md rounded-[28px] border border-outline-variant bg-surface-container-lowest p-6 text-center shadow-lg">
        ...
        <div class="mb-6">
            ...
            <p class="mt-1 text-sm text-on-surface-variant">
                Escanea con la cámara de tu celular el Qr para contactar a <span class="font-semibold text-primary">Ch'Tacos</span> en WhatsApp 
            </p>
        </div>
